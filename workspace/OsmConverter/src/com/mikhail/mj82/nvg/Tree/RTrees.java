...
public class RTrees implements Serializable {
	...
	private String name = ""; // Имя поискового дерева (совпадает с именем файлов карты)
	private long crc = 0; // Контрольная сумма карты
	
	/**
	 * Возвращает имя поискового дерева, которое совпадает с именем файлов карты.
	 * @return имя поискового дерева
	 */
	public String getRTreeName() {
		return name;
	}
	
	/**
	 * Записывает имя поискового дерева, которое совпадает с именем файлов карты.
	 * @param name новое имя поискового дерева
	 */
	public void setRTreeName(String name) {
		this.name = name;
	}
	
	/**
	 * Записывает значение контрольной суммы.
