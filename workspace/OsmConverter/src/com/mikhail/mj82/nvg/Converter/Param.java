...
public class Param {
	...
	public static final byte[] index_format = "INVG".getBytes(); 
	...
	// Смещения в структуре заголовков файлов карт (map.hnvg, map.dnvg, mapIndex) 
	...
	public static final long maxId_seek = 44; // Максимальное значение идентификатора элемента карты
	...
	// Смещения в структуре заголовка файла карты mapIndex
	public static final long map_index_descriptionSize_seek = 12; // Размер описания в байтах
	public static final long map_index_name_seek = 16; // Название карты
	
	// Смещения в структуре элементов карты файла карты mapIndex
	public static final long leftMbr_seek = 8; // Координаты левой стороны ограничивающего элемент карты прямоугольника
	public static final long topMbr_seek = 16; // Координаты верхней стороны ограничивающего элемент карты прямоугольника
	public static final long rightMbr_seek = 24; // Координаты правой стороны ограничивающего элемент карты прямоугольника
	public static final long bottomMbr_seek = 32; // Координаты нижней стороны ограничивающего элемент карты прямоугольника	
...
//	public static HashMap<Long, Long> seek_ways_used_in_relations = new HashMap<Long, Long>(); // Линии, которые используются в отношениях
	...
	public static final long dnvg_headerSize = 52; // Размер заголовка map.dnvg файла карты
	...
	public static final long indexElementSize = 40; // Общий размер данных элемента (в байтах) mapIndex файла
