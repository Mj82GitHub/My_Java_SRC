...
import com.mikhail.mj82.Triangulation.Decompositor.Scaning;
import com.mikhail.mj82.Triangulation.Mj_Point.Point_position;
...
//		delete();
	 ...
	 * 
	 * @param v указанную в качестве аргумента вершина
	 * @return вершина с координатами равными координатамзаданной вершины в качестве аргумента
	 */
